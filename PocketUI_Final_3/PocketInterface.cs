...
{
    public partial class PocketInterface : Form
    {
        ...
        public PocketInterface()
        {
            ...
            //////////////////// NEWWWWWWWWWW CODEEEEEEEEE
            flowLayoutPanel_Display.DragEnter += flowLayoutPanel_Display_DragEnter;
            flowLayoutPanel_Display.DragDrop += flowLayoutPanel_Display_DragDrop;
            //////////////////// NEWWWWWWWWWW CODEEEEEEEEE

            this.AllowDrop = true;


            this.DragEnter += new DragEventHandler(PocketInterface_DragEnter);
            this.DragDrop += new DragEventHandler(PocketInterface_DragDrop);


            //this.DragEnter += new DragEventHandler(flowLayoutPanel_Display_DragEnter);
            //this.DragDrop += new DragEventHandler(flowLayoutPanel_Display_DragDrop);
        ...
        private void PocketInterface_DragEnter(object sender, DragEventArgs e)
        //private void PocketInterface_Load_DragEnter(object sender, DragEventArgs e)
        {
        ...
        private async void PocketInterface_DragDrop(object sender, DragEventArgs e)
        //private async void PocketInterface_Load_DragDrop(object sender, DragEventArgs e)
        {
        ...
        // NEW SHITTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT

        private void flowLayoutPanel_Display_DragEnter(object sender, DragEventArgs e)
        {
            if (e.Data != null && e.Data.GetDataPresent(DataFormats.FileDrop))
            {
                e.Effect = DragDropEffects.Copy;
        ...
        private void flowLayoutPanel_Display_DragDrop(object sender, DragEventArgs e)
        {
            string[] filePaths = (string[])e.Data.GetData(DataFormats.FileDrop);
        ...
        private void PocketInterface_Load(object sender, EventArgs e)
        {
        ...
        private void PocketInterface_Tab_Display_UserControl(PocketLibrary_temp.Tab newTab)
        {

            UserControlTabDisplay_Final customControl = new UserControlTabDisplay_Final();
            ...
            customControl.PictureBox_Tab_Image = ConvertImageToBitmap(newTab.TabImage);
            ...
            customControl.Click += UserControl_Tab_Display_Final_Click;
        ...
        private void Tab_DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            if (sender is UserControlTabDisplay_Final customControl)
            {

                //connector.DeleteTab(customControl.TimeInserted);
                SqlConnector.DeleteTab(customControl.TimeInserted);
            }
        }
        private void File_DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            //if (sender is UserControlFileDisplay fileDisplay)
            if (sender is UserControlFileDisplay_Final fileDisplay)
            {
                ...
                MessageBox.Show(SqlConnector.DeleteFile(fileDisplay.TimeInserted).ToString());
            }
        }

        private void PocketInterface_File_Display_UserControl(PocketLibrary_temp.Files newFile)
        {
            //UserControlFileDisplay customControl = new UserControlFileDisplay();
            UserControlFileDisplay_Final customControl = new UserControlFileDisplay_Final();
            ...
            ////////////////////NEW SHITTTTTTTTTTTTTTTTTTTTTT
            if (newFile.FileImage == null)
            {

                FileOrFolder(newFile.FilePath, newFile);
            }
            ...
            customControl.PictureBox_File_Image = ConvertImageToBitmap(newFile.FileImage);
        ...
        private void label_File_Name_Click(object sender, EventArgs e)
        {
            ...
            var clickedControl = sender as UserControlFileDisplay_Final;
        ...
        private async void button_add_tab_Click_1(object sender, EventArgs e)
        ...
        private void BindData(string dataType)
        {
            ...
            else if (dataType == "Tabs")
            {
                ...
                {
                    PocketInterface_Tab_Display_UserControl(DisplayData);
            ...
            else if (dataType == "Files")
            {
                ...
                {
                    PocketInterface_File_Display_UserControl(DisplayData);
                }
            }
            else
            {
        ...
        private void CheckIsTabOrFile(BothTabsFiles DisplayData)
        {
            ...
            if (DisplayData.TabTitle != null)
            {
                ...
                PocketInterface_Tab_Display_UserControl(displayTab);
            }
            ...
            else if (DisplayData.FileName != null)
            {
                ...
                PocketInterface_File_Display_UserControl(displayFile);
            }
            else
            {
        ...
        private void button_apply_filters_sort_Click_1(object sender, EventArgs e)
        {
        ...
        {
            OpenTab(sender as UserControlTabDisplay_Final);
        }
        ...
        private void OpenTab(UserControlTabDisplay_Final clickedTab)
        {
            try
            {
                Task.Run(() =>
        ...
        private void flowLayoutPanel_Display_Paint_1(object sender, PaintEventArgs e)
        {

        }

        private void checkBox_Alphabetical_order_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void flowLayoutPanel_Display_Paint_2(object sender, PaintEventArgs e)
        {
...
private void flowLayoutPanel_Display_Paint_2_DragEnter(object sender, PaintEventArgs e)
{
   if (e.Data != null && e.Data.GetDataPresent(DataFormats.FileDrop))
   {
       e.Effect = DragDropEffects.Copy;
...
private void flowLayoutPanel_Display_Paint_2_DragDrop(object sender, PaintEventArgs e)
{
   string[] filePaths = (string[])e.Data.GetData(DataFormats.FileDrop);
...
*/
        //private void button_add_tab_Click_1(object sender, EventArgs e)
        //{
